...
<section class="section" id="sec">
    <div class="contianer">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="mt-5 pt-5 display-4 f-800 text-center">انتقادات</h2>
...
<section class="section" style="direction: rtl;">
    <div class="container">
        <div class="row">
            <div class="col-lg-10">
                <h3 class="f-800" >فورم وارد شدن</h3>
                <p class="lead">شما میتوانید با فورم زیر با استفاده از ایمیل و رمز ورودی خود وارد شوید </p>
                <form action="controler/check.php" method="POST">
                    
                    <?php
                    if(isset($_GET["login"])){
                        echo "username and password are incorect";
                    }
                    ...
                    <div class="input-group input-group-lg mb-2">
                      ...
                      <div class="input-group input-group-lg mb-2">
                        ...
                        <input type="password" class="form-control" placeholder="رمز ورودی" name="password">
                      </div>
                      
                      <input type="submit" value="وارد شدن" class="btn btn-primary btn-lg btn-block f-800">
                </form>
            </div>
        </div>
    </div>
